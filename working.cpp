...
{   cout<<"\nEnter your choice\n";
    ...
    cout<<"2.To Find all the mutual friends between two people in the network";red();cout<<"(SAPI (text 2 speech) Enabled)\n";white();
    cout<<"3.To Find the connection links between two people in the network\n";
    cout<<"4.To Find the friends of a person in the network";red();cout<<"(SAPI (text 2 speech) Enabled)\n";white();
...
for(int i=1; i<=users;i++)
    ...
    break;
 case 2: cout<<"enter the uid of users \n";
 cin>>a>>b;
...
break;
case 5: minimumrelation(connection2);
break;
case 6:
    image();
    break;
